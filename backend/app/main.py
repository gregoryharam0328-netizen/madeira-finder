...
_dev = [
    ...
    "http://127.0.0.1:3000",
    "http://[::1]:3000",
    "https://madeira-frontend.onrender.com",
]
...
# Preview / alternate hosts (e.g. https://*.onrender.com) — see BACKEND_CORS_ORIGIN_REGEX in .env.example.
_origin_regex = (settings.backend_cors_origin_regex or "").strip() or None
app.add_middleware(
    CORSMiddleware,
